...
function easyblog_scripts() {
	...
	wp_enqueue_style( 'easyblog-roboto', '//fonts.css.network/css?family=Roboto:400,300,500,700,900' );
	wp_enqueue_style( 'easyblog-delius-swash-caps', '//fonts.css.network/css?family=Delius+Swash+Caps' );
